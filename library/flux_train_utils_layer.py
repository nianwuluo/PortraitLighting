...
def sample_image_inference(
    ...
    #width = prompt_dict.get("width", 1536)
    # width = prompt_dict.get("width", 1024)
    # width = prompt_dict.get("width", 960)
...
def denoise(
    ...
    for t_curr, t_prev in zip(tqdm(timesteps[:-1]), timesteps[1:]):
        ...
        '''
        # packed_latent_height, packed_latent_width = ae_outputs.shape[2] // 2, ae_outputs.shape[3]*2 // 2
        ...
        # img[:,:, : , img.shape[3] // 2:img.shape[3] ] = ae_outputs
