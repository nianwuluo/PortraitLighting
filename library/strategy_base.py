    ...
    def _load_tokenizer(
        ...
        if tokenizer is None:
            ...
            if model_id == "openai/clip-vit-large-patch14":
                clip_vit_path = "autodl-tmp/clip-vit-large-patch14"
                tokenizer = model_class.from_pretrained(clip_vit_path)
            elif model_id == "google/t5-v1_1-xxl":
                t5__path = "autodl-tmp/t5"
                tokenizer = model_class.from_pretrained(t5__path)
