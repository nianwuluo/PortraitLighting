...
from library import flux_models, flux_train_utils_layer as flux_train_utils, flux_utils, sd3_train_utils, \
...
if __name__ == "__main__":
    BASE_FLUX_CHECKPOINT = 'models/flux1-dev.safetensors'
    LORA_WEIGHTS_PATH = 'output/relight-flux-14800(without_LoRA)/relight-flux-14800(without_LoRA).safetensors'
    ...
    FOREGROUND_DIR = "input/test/image/portrait/"
    BACKGROUND_DIR = "input/test/image/background/"
    PROMPT_DIR = "input/test/prompt/prompt-232/"
    STORE_DIR = "result/relight-flux-14800(without_LoRA)/test-232/"
