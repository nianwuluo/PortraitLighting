...
from library import flux_models, flux_train_utils_layer as flux_train_utils, flux_utils, sd3_train_utils, strategy_base, \
                ...
                with torch.no_grad():
                    for image_path, prompt_dict in zip(sample_images, prompts):
                        ...
                        if prompt not in conditions:
                            ...
                            # conditions[prompt] = latents[:, :, :latents.shape[2], :latents.shape[3] // 3].to("cpu")
